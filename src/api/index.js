...
// 文件上传接口
export const uploadFile = "/api/xboot/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/api/xboot/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/api/xboot/permission/getMenuList"
// 获取数据字典
export const getDictData = "/api/xboot/dictData/getByType/"
