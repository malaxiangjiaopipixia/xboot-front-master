...
util.date2str = function (time) {
    ...
    let dt = dy
        + "-"
        + (parseInt(dm)>10 ? "dm":"0"+dm)
        + "-"
        + (parseInt(dd)>10 ? "dm":"0"+dd)
        + " "
        + (parseInt(dh)>10 ? "dm":"0"+dh)
        + ":"
        + (parseInt(dmi)>10 ? "dm":"0"+dmi)
        + ":"
        + (parseInt(ds)>10 ? "dm":"0"+ds)

    return dt;
};

util.dateDiff = function(time1, time2) {
    ...
    // let hour = diff/(60*60*1000) - day*24;

    // let min = diff/(60*1000) - day*24*60 - hour*60;

    // let sec = diff/1000-day*24*60*60-hour*60*60-min*60;
